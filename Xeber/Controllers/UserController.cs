...
namespace Xeber.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<ApplicationUser> _userManager, IPasswordValidator<ApplicationUser> passValidator, IPasswordHasher<ApplicationUser> passHasher)
        {
